...
configuration option above, changing the configuration of the running pager.
Note any configuration changes are for the running instance only, to make
any changes permanent, update the fvwm config file.
